...
public class TechnologyFragment extends Fragment {
    ...
    public static  TechnologyFragment newInstance(int page, String title){
        TechnologyFragment frag = new TechnologyFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView = (RecyclerView) rootView.findViewById(R.id.recycler_view_technology);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView.addItemDecoration(new DividerItemDecoration(recyclerView.getContext(), DividerItemDecoration.VERTICAL));

        spinnerView = (RelativeLayout)rootView.findViewById(R.id.spinner_technology);


        mswipeRefreshLayout = rootView.findViewById(R.id.refresh_technology);
        mswipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                new getTechnologyHeadlines().execute();
            }
        });
    ...
    private class getTechnologyHeadlines extends AsyncTask<Void,Void,String>{
        ...
        protected String doInBackground(Void... voids) {
            ...
            try{
                ...
                URL url = new URL("https://frontendinreact.wn.r.appspot.com/get_top10_technology_guardian");
