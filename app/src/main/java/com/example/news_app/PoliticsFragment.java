...
public class PoliticsFragment extends Fragment {
    ...
    public static  PoliticsFragment newInstance(int page, String title){
        PoliticsFragment frag = new PoliticsFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar = rootView.findViewById(R.id.progress_bar_politics);
        progressBar.getIndeterminateDrawable().setColorFilter(Color.parseColor("#2D42BD"), PorterDuff.Mode.MULTIPLY);
        recyclerView = (RecyclerView)rootView.findViewById(R.id.recycler_view_politics);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));
        recyclerView.addItemDecoration(new DividerItemDecoration(recyclerView.getContext(), DividerItemDecoration.VERTICAL));
        spinnerView = (RelativeLayout)rootView.findViewById(R.id.spinner_politics);

        mSwipeRefreshLayout = rootView.findViewById(R.id.refresh_politics);
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                new getPoliticsHeadlines().execute();
            }
        });
    ...
    private class getPoliticsHeadlines extends AsyncTask<Void,Void,String>{
        ...
        protected String doInBackground(Void... voids) {
            ...
            try{
                URL url = new URL("https://frontendinreact.wn.r.appspot.com/get_top10_politics_guardian");
