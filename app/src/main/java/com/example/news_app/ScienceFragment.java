...
public class ScienceFragment extends Fragment {
    ...
    public static  ScienceFragment newInstance(int page, String title){
        ScienceFragment frag = new ScienceFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progressBar = rootView.findViewById(R.id.progress_bar_science);
        progressBar.getIndeterminateDrawable().setColorFilter(Color.parseColor("#2D42BD"), PorterDuff.Mode.MULTIPLY);

        recyclerView = (RecyclerView)rootView.findViewById(R.id.recycler_view_science);
        recyclerView.setLayoutManager(new LinearLayoutManager(getActivity()));

        recyclerView.addItemDecoration(new DividerItemDecoration(recyclerView.getContext(), DividerItemDecoration.VERTICAL));
        spinnerView = (RelativeLayout)rootView.findViewById(R.id.spinner_science);

        mSwipeRefreshLayout = rootView.findViewById(R.id.refresh_science);
        mSwipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                new getScienceHeadlines().execute();
            }
        });
    ...
    private class getScienceHeadlines extends AsyncTask<Void,Void,String>{
        ...
        protected String doInBackground(Void ... params) {
            try {
                URL url = new URL("https://frontendinreact.wn.r.appspot.com/get_top10_science_guardian");
