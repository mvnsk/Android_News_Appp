...
public class HomePageAdapter  extends RecyclerView.Adapter<HomePageAdapter.HomePageView> {
    ...
    public HomePageAdapter(Context context, ArrayList<Mydata> newsArrayList) {
    ...
    @NonNull
    @Override
    public HomePageView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final HomePageAdapter.HomePageView bookMarkView, final int position) {
   ...
   /*     String time_woz =originalDateTime.substring(0, originalDateTime.length() - 1);
    ...
    public class HomePageView extends RecyclerView.ViewHolder{
        ...
        public HomePageView(@NonNull View itemView) {
            super(itemView);
            news_title_text_view = (TextView) itemView.findViewById(R.id.title);
            news_image_view = (ImageView) itemView.findViewById(R.id.card_image);
            sectionView = (TextView) itemView.findViewById(R.id.section);
            timeView = (TextView) itemView.findViewById(R.id.time);
            btn = (ImageButton) itemView.findViewById(R.id.bookmark_image);
