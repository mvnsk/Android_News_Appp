...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fetching_news=(TextView) findViewById(R.id.fetching_news);
       ...
       // recyclerView.addItemDecoration(new VerticalSpaceItemDecoration(20));
        ...
        RecycleClick.addTo(recyclerView).setOnItemClickListener(new RecycleClick.OnItemClickListener() {
            ...
            public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                ...
                Mydata Mydata = fetchedlist.get(position);//mAdapter.getItem(position);

                Intent openMainNews = new Intent(MainActivity.this, DetailPage.class);
                ...
                System.out.println("yippy before click state is "+ Mydata.issaved());
                ...
                switch (item.getItemId()){
                    ...
                    case R.id.trending:
                        ...
                        startActivity(trendingIntent);
                         break;
                    case R.id.bookmark:
                        Intent favouriteIntent = new Intent(MainActivity.this, BookMarkActivity.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        List<Mydata> newlyfetched= new ArrayList<>();;
                        try {
                                ...
                                try {
                                    ...
                                    String url = article.getString("webUrl");
                                     if (map.containsKey(url)) {
                                        ...
                                        Mydata temp = fetchedlist.get(index);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        mAdapter= new HomePageAdapter(getApplicationContext(), (ArrayList<Mydata>) fetchedlist);
...
// Add the request to the RequestQueue.
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    if(open_Mydata.issaved().equals("yes")){
                        ...
                        fetchedlist.set(position,open_Mydata);
                    ...
                    /* if(newsArrayList.size()>0) {
                        ...
                        TextView no_bookmarks= findViewById(R.id.no_bookmarks);
                    ...
                    Log.d("Favo fetchedlist.set(position,open_Mydata);\n" +
    ...
    protected void onResume() {
        ...
        try{
            Mydata tempnews = fetchedlist.get(clicked_position);
            SharedPreferences pref = getSharedPreferences("Bookmarked_articles", 0); // 0 - for private mode
            SharedPreferences.Editor editor = pref.edit();
            if(pref.contains(DetailPage.BOOKMARK_DETAIL_TAG)) {
                String detail_bookmarked = pref.getString(DetailPage.BOOKMARK_DETAIL_TAG, null);
      ...
      /*  try {
            if(bookmark_removed){
                Mydata article= fetchedlist.get(clicked_position);
